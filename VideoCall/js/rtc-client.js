      ...
      try {
        ...
        switch (error.name) {
          case 'NotReadableError':
            alert(
              'A câmera/microfone não pode ser acessada temporariamente. Certifique-se de que o sistema permite que o navegador atual acesse a câmera/microfone e que nenhum outro aplicativo esteja ocupando a câmera/microfone.'
            );
            return;
          case 'NotAllowedError':
            if (error.message === 'Permission denied by system') {
              alert('Certifique-se de que o sistema permite que o navegador atual acesse a câmera/microfone');
            } else {
          ...
          case 'NotFoundError':
            alert(
              'O navegador não pode obter o dispositivo de câmera/microfone. Verifique a conexão do dispositivo e certifique-se de que o sistema permite que o navegador atual acesse a câmera/microfone.'
            );
            return;
          default:
            return;
